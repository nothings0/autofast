...
const MyBill = () => {
  ...
  const bookingStatuses = ["Tất cả", "Đã thanh toán", "Chưa thanh toán"];
  ...
  useEffect(() => {
    if (searchTerm === "") {
      ...
      const filtered = bookings.filter((booking) =>
        Object.values(booking.name).some((value) =>
  ...
  useEffect(() => {
    if (selectedStatus === "Tất cả") {
      ...
      const filtered = bookings.filter(
        (booking) => booking.status_payment === selectedStatus
      );
      setFilteredBookings(filtered);
    }
        ...
        {showBill && (
          <div style={backdropStyle}>
            <div style={billContainerStyle}>
              ...
              {selectBooking?.status_payment != "Chưa thanh toán" && (
          ...
          <table style={tableStyle}>
            <thead>
              <tr>
                ...
                <th style={thStyle}>Trạng Thái </th>
                <th style={thStyle}>Trạng Thái Hóa Đơn </th>
            ...
            <tbody>
              {filteredBookings.map((booking) => (
                <tr key={booking.id}>
                  ...
                  <td style={tdStyle}>{booking.status_payment}</td>
                  ...
                  <td style={tdStyle}>
                    ...
                    {booking.status_payment === "Đã thanh toán" && (
                      <Link to={`/mybill/${booking.id}/review`}>
                        {" "}
